                ...
                if piece_clicked_coords == [-1, -1]:
                    ...
                    for piece in pieces:
                        if piece.x == x and piece.y == y:
                            if whites_move == True and piece.colour == "black" or whites_move == False and piece.colour == "white":
                                break
    ...
    if whites_move:
        ...
        for piece in pieces:
            if piece.type == "rook" and piece.colour == "black":
                ...
                for i in range(8):
                    if (piece.x + i == whites_king_x or piece.x - i == whites_king_x) and (piece.y + i == whites_king_y or piece.y - i == whites_king_y):
                        return True
            elif piece.type == "knight" and piece.colour == "black":
                if ((piece.x + 2 == whites_king_x or piece.x - 2 == whites_king_x) and (piece.y + 1 == whites_king_y or piece.y - 1 == whites_king_y)) or ((piece.x + 1 == whites_king_x or piece.x - 1 == whites_king_x) and (piece.y + 2 == whites_king_y or piece.y - 2 == whites_king_y)):
                    return True
        ...
        for piece in pieces:
            if piece.type == "rook" and piece.colour == "white":
                ...
                for i in range(8):
                    if (piece.x + i == black_king_x or piece.x - i == black_king_x) and (piece.y + i == black_king_y or piece.y - i == black_king_y):
                        return True
            elif piece.type == "knight" and piece.colour == "white":
                if ((piece.x + 2 == black_king_x or piece.x - 2 == black_king_x) and (piece.y + 1 == black_king_y or piece.y - 1 == black_king_y)) or ((piece.x + 1 == black_king_x or piece.x - 1 == black_king_x) and (piece.y + 2 == black_king_y or piece.y - 2 == black_king_y)):
                    return True
